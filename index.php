...
<html class="no-js" lang="zxx">
    <head>
        ...
        <title>DINO FASHION | INICIO</title>
                  ...
                  <div class="col-md-4">
                     <div class="box ">
                              ...
                              <g>
                                 <g>
                                    <path d="M476.158,231.363l-13.259-53.035c3.625-0.77,6.345-3.986,6.345-7.839v-8.551c0-18.566-15.105-33.67-33.67-33.67h-60.392
                                          ...
                                          c-5.01,0-9.086-4.076-9.086-9.086v-9.086h18.171V299.29z" data-aos=" fade-up" />
                                 </g>
                              </g>
                              <g>
                                 <g>
                        ...
                        <div class="detail-box" >
                           ...
                           <p>
                            DinoFashion se caracteriza por realizar las estregas de manera rapida, y segura.
                           </p>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="box ">
                        ...
                        <div class="detail-box">
                           ...
                           <p>
                            Contamos con envios gratis a clientes estrellas, y por tu primera compra tendras el envio gratis, no olvides que DinoFashion cuenta con promociones, descuentos y cupones.
                           </p>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="box ">
                        ...
                        <div class="detail-box">
                           ...
                           <p>
                              Somos una empresa que te brinda la mejor calidad en nuestros productos. si no es de calidad te lo regresamos.
                           </p>
                        </div>
                     </div>
                  </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="subscribe_part_content">
                        <h2>¡Obtenga promociones y actualizaciones!</h2>
                        <p>En dinofashion encontraras los mejores descuentos, y cupones, no olvides suscribirte.</p>
                        <div class="subscribe_form">
                            <input type="email" placeholder="Introduce tu correo electrónico">
                            <a href="#" class="btn_1">Subscribete</a>
                        </div>
                    </div>
                </div>
            </div>
